...
router.put('/:uidPatient', middleware.SuperAuthorization, medicalTestHandler.UpdateMedicalTest);
router.delete('/:uid', middleware.SuperAuthorization, medicalTestHandler.DeleteMedicalTest);
